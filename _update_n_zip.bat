...
"C:\Program Files\7-Zip\7z.exe" a -tzip _rom2maps.zip 1_intro\* 2_a2\* 3_kids\* 4_nival\* 5_med\* 6_hard\* 7_horror\* 8_t1\* 9_t2\* 10_t3\* 11_t4\*
...
copy /y 11_t4 "C:\games\a2-main\maps"
